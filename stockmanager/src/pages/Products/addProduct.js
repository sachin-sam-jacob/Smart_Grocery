...
const ProductUpload = () => {
    ...
    const inputChange = (e) => {
        ...
        setFormFields(prevFields => {
            ...
            // Automatically calculate price when oldPrice and discount are provided
            if ((name === 'oldPrice' || name === 'discount') && updatedFields.oldPrice && updatedFields.discount) {
                const oldPrice = parseFloat(updatedFields.oldPrice);
                const discount = parseFloat(updatedFields.discount);
                if (!isNaN(oldPrice) && !isNaN(discount)) {
                    const calculatedPrice = oldPrice - (oldPrice * (discount / 100));
                    updatedFields.price = calculatedPrice.toFixed(2);
                }
            }
                            ...
                            <div className='card p-4 mt-0'>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col'>
                                        <div className='form-group'>
                                            <h6>PRICE</h6>
                                            <input type='text' name="price" value={formFields.price} readOnly />
                                        </div>
                                    </div>
